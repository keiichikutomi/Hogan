...
#define DEFAULTINPUTFILE  "kawa05.inp"
/*#define DEFAULTINPUTFILE  "aki.inl"*/
#define DEFAULTINPUTFILEZ "got05.inl"
#define DEFAULTINPUTFILEX "got05.ihx"
#define DEFAULTINPUTFILEY "got05.ihy"
/*#define DEFAULTINPUTFILE  "quad01.inp"*/
#define DEFAULTOUTPUTFILE  "hogtxt.otp"
#define DEFAULTOUTPUTFILEZ "got05.otl"
#define DEFAULTOUTPUTFILEX "got05.ohx"
#define DEFAULTOUTPUTFILEY "got05.ohy"

/*#define DEFAULTSECTIONFILE "hogtxt.lst"*/
#define DEFAULTSECTIONFILE "got05.lst"

/*DEFAULT VIEW PARAMETERS.*/
struct viewparam vpdefault={PERSPECTIVE,0,0,          /*TYPE,ORIGIN*/
                            -70.0,12.0, 500.0,              /*ANGLE*/
                            1.0,                            /*GFACT*/
                            {0,0,{ 6.0, 3.0,15.0}},         /*FOCUS*/
                            {{0,0,{1000.0, 1000.0, 1000.0}},  /*MAX*/
                             {0,0,{-100.0, -100.0, -100.0}}}, /*MIN*/
                            {1.0, 0.5,                  /*AXIS SIZE*/
                             100.0, 0.0, 0.1,       /*FACTORS D,Q,M*/
                             0.5,                           /*PITCH*/
                             3},                            /*HINGE*/
                            {8000.0}};       /*ODV=L*/ /*ORGAN TEST*/
...
BOOL CALLBACK DialogProcElemType(HWND,UINT,WPARAM,LPARAM);
BOOL CALLBACK DialogProcSectRegist(HWND,UINT,WPARAM,LPARAM);
BOOL CALLBACK DialogProcConf(HWND,UINT,WPARAM,LPARAM);
BOOL CALLBACK DialogProcBond(HWND,UINT,WPARAM,LPARAM);
...
/*WINDOW FOR DRAWING WITH POPUP MENU.*/
{
  ...
  switch(message)
  {
    case WM_PAINT:
      ...
      hdc = GetDC(hwnd);
      setfontformat(hdc,15,6,/*"Terminal"*/"‚l‚r –¾’©",0,255,255);
    ...
    case WM_LBUTTONDOWN:
      ...
      if((wmenu.childs+2)->vparam.vflag.mv.ftype==F_ORGAN)
      {
        if(globalstatus==SECTIONPAINT)
        {
          ...
          setfontformat(hdc,15,6,/*"Terminal"*/"‚l‚r –¾’©",255,255,255);
...
BOOL CALLBACK DialogProcElemType(HWND hdwnd,
                                 UINT message,
                                 WPARAM wParam,
                                 LPARAM lParam)
...
BOOL CALLBACK DialogProcConf(HWND hdwnd,
                             UINT message,
                             WPARAM wParam,
                             LPARAM lParam)
...
BOOL CALLBACK DialogProcBond(HWND hdwnd,
                             UINT message,
                             WPARAM wParam,
                             LPARAM lParam)
/*POPUP DIALOG BOX FOR CHANGE BOND.*/

       ...
       vp.vflag.ev.etype[(af.elems+i)->sect->type]==1)
    {
               ...
               (af.elems+i)->srate[3]>1.0))
      {
        drawglobalwire(hdc,vp,af,*(af.elems+i),255,0,150,
              ...
              ((af.elems+i)->srate[0]>0.8 || /*0.9*/ /*0.8*/
               ...
               (af.elems+i)->srate[3]>0.71428))
      {
        drawglobalwire(hdc,vp,af,*(af.elems+i),255,255,0,
              ...
              ((af.elems+i)->srate[0]>0.6 || /*0.7*/ /*0.6*/
               ...
               (af.elems+i)->srate[3]>0.6))
      {
        drawglobalwire(hdc,vp,af,*(af.elems+i),150,255,0,
              ...
              ((af.elems+i)->srate[0]>0.5 || /*0.6*/ /*0.5*/
               ...
               (af.elems+i)->srate[3]>0.5))
      {
        drawglobalwire(hdc,vp,af,*(af.elems+i),0,255,0,
              ...
              ((af.elems+i)->srate[0]>0.4 || /*0.5*/ /*0.4*/
...
/*DISTRIBUTE ELEMENT WEIGHT INTO NODE WEIGHT,CMQ.*/
{
  ...
  else if(!strncmp(non,"aoki",4)) strcpy(prj,"aoki");
  else if(!strncmp(non,"aone",4)) strcpy(prj,"aone");
  else if(!strncmp(non,"koma",4)) strcpy(prj,"koma");
  else if(!strncmp(non,"nemo",4)) strcpy(prj,"nemo");
  else if(!strncmp(non,"hiro",4)) strcpy(prj,"hiro");
  else if(!strncmp(non,"kemi",4)) strcpy(prj,"kemi");
  else if(!strncmp(non,"eifu",4)) strcpy(prj,"eifu");
  else if(!strncmp(non,"ise",3))  strcpy(prj,"ise");

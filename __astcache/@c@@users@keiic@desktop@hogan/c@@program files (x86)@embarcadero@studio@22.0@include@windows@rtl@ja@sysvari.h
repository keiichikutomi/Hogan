...
#error VARIANT_TVARIANT_SUPPORT がサポートされていません
  #endif
  #if defined(VARIANT_AUTOMATION_SUPPORT)
#error VARIANT_TAUTOMATION_SUPPORT がサポートされていません
  #endif
  #if defined(VARIANT_NATIVE_SUPPORT)
#error VARIANT_NATIVE_SUPPORT がサポートされていません
  #endif
#endif
...
#error エラー: sizeof(OleVariant) != sizeof(Variant)
#endif
#if defined(VARIANT_NATIVE_SUPPORT)
  #if sizeof(OleVariant) != sizeof(VARIANT)
#error エラー: sizeof(OleVariant) != sizeof(VARIANT)
...
#error エラー: sizeof(Variant) != sizeof(VARIANT)
  #endif
#endif
#endif
#if defined(__clang__)

...
#error このファイルを直接インクルードしないでください。'System.hpp' をインクルードしてください。
#endif
#if !defined(__cplusplus)
#error sysmac.h は C モードで使用できません。このヘッダーを使うには C++ でなければなりません!
#endif
...
#error "NO_STRICT が定義されています。Delphi ランタイムを使用するには STRICT マングルが必要です"
#error "'http://docwiki.embarcadero.com/RADStudio/ja/C%2B%2B_アプリケーションでの厳密な型チェックの使用' を参照してください"
    #endif
  #endif
#endif

#if defined(__BORLANDC__) && (__BORLANDC__ < 0x500)
#error BCW 5.0 以降が必要です
#endif
...
#error ""System.hpp/sysmac.h および関連するヘッダーを使用するには __declspec(uuid(..)) と __uuidof がサポートされている必要があります"  "
#endif

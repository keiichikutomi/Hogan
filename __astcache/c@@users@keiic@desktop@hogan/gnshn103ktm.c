...
int gnshn101(struct arclmframe *af)
	...
	/* change x wave*/
	fxacc = fopen("el1220w04.txt","r");   /*模擬地震波：EL CENTRO*/
	fyacc = NULL;
	fzacc = NULL;
	...
	afact = 125.0/100.061; /*模擬地震波：EL CENTRO*/ //BezierDome
...
*/
	...
	} /* END OF LAP.REPEAT UNTIL INSTABLE. 振動繰り返しここまで */
...
int gnshn102(struct arclmframe *af)
	...
	*/
	...
	if (dtype == 1) {
		...
		/*change eigen period*/
		T1 = 1.58; /* FUNDAMENTAL NATURAL PERIOD 1次固有周期 */
		/* T1=0.78; */ /* FOR E-DEFENSE*[sec] */
		/* T1=0.74210; */ /* FOR HAKUSHIMA Y */
		/* T1=0.19261; */ /* FOR HAKUSHIMA X */
		w1 = 2.0 * PI / T1;

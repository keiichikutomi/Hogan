...
/*if(!strcmp(prj,"izu") && (sect1.code==901 ||
          ...
          else
          {
            ...
            for(ia=0;ia<=na;ia++) /*FOR AXIS*/
            {
              ...
              {
                Ma=allowablebendingofwood(PLONG,sect1,h,ia,(-lN));
              }
              /*if(Ma<0.1) Ma=0.1;*/
            ...
            for(sign=0;sign<=1;sign++) /*LOAD POSITIVE,NEGATIVE.*/
            {
              ...
              else
              {
                ...
                for(ia=0;ia<=na;ia++) /*FOR AXIS*/
                {
                  ...
                  {
                    Ma=allowablebendingofwood(PSHORT,sect1,h,ia,(-sN));
                  }
                  /*if(Ma<0.1) Ma=0.1;*/
...
/*STEEL TYPE:HKYOU BY RECTS,HKYOU,HWEAK*/
{
  ...
  double H,B,tw,tf;
  double LAM,lam,nyu,sfca,sftu,sfn;
...
if(!strcmp(prj,"vene") && sect.code==201) lk*=2.0*sqrt(2.0);
  ...
  if(Nd<0.0)  Na=-allowablecompressionofsteel(E,sF,lk,sect);
...
if(!strcmp(prj,"noa")  && sect.code==201) i=iyy;
if(!strcmp(prj,"noa")  && sect.code==501) i=ixx;
if(!strcmp(prj,"noa")  && sect.code==502) i=ixx;
...
if(!strcmp(prj,"hiro") && sect.code==501) i=ixx;

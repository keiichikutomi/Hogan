...
{
  char non[10];
  double W0,w0,w1,w2,w3,w4,l1,l2,L0,L1,L2,L3,width;
  ...
  sum.Ci-=cmq.Cj; sum.Cj-=cmq.Ci;
  sum.Mc0+=cmq.Mc0;
  sum.Qi0+=cmq.Qj0; sum.Qj0+=cmq.Qi0;
  ...
  sum.Ci+=cmq.Ci; sum.Cj+=cmq.Cj;
  sum.Mc0+=cmq.Mc0;
  sum.Qi0+=cmq.Qi0; sum.Qj0+=cmq.Qj0;
  ...
  printf("SUM FOR WIDTH=%.5f[m]\n",width);
  printf("Ci=%.5f[tfm] Cj=%.5f[tfm] Mc=%.5f[tf] ",
         (width*sum.Ci),(width*sum.Cj),(width*sum.Mc0));
  printf("Qi=%.5f[tf] Qj=%.5f[tf]\n",
         (width*sum.Qi0),(width*sum.Qj0));

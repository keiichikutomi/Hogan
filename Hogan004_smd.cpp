...
#include "archg120-4.c"          /*ANALYSIS NONLINEAR,MATH,VIEWING.*/
#include "archg015.c"                     /*ANALYSIS STATIC LINEAR.*/
#include "bclng016.c"                           /*ELASTIC BUCKLING.*/
#include "qadhg001.c"               /*ANALYSIS BIQUADRATIC ELEMENT.*/
#include "srcal015_03.c"                         /*DRAW SECTIONS LIST.*/
...
#define INPUTWIDTH 170 /*146*/      /*DIALOGUE FONT:"SYSTEM" 18pts.*/
...
#define DEFAULTINPUTFILE   "sdai06_3.inp"
#define DEFAULTINPUTFILEZ  "sdai06_3.inl"
#define DEFAULTINPUTFILEX  "sdai06_3.ihx"
#define DEFAULTINPUTFILEY  "sdai06_3.ihy"
#define DEFAULTOUTPUTFILE  "sdai06_3.ohy"
#define DEFAULTOUTPUTFILEZ "sdai06_3.otl"
#define DEFAULTOUTPUTFILEX "sdai06_3.ohx"
#define DEFAULTOUTPUTFILEY "sdai06_3.ohy"
#define DEFAULTSECTIONFILE "sdai06_3.lst"
...
/*MessageBox(NULL,"Pass 2","Add Elem",MB_OK);*/
	...
	case WM_MBUTTONDOWN: /* yuya mbutton 2018.8.22 */
		x = LOWORD(lParam);
		y = HIWORD(lParam);
	...
	case WM_MBUTTONUP: /* yuya mbutton 2018.8.22 */
...
/************/
			  ...
			  (wParam == MK_LBUTTON))
      {
		...
		SendMessage((wdraw.childs+1)->hwnd,WM_PAINT,0,0);
			  ...
			  (wdraw.childs+1)->lstatus==MOVE &&
			  (wParam == MK_LBUTTON)|| (wParam == MK_MBUTTON)) /* yuya mbutton 2018.8.22 */
	  {
		point.x = LOWORD(lParam);
		point.y = HIWORD(lParam);
